		...
		while (theLocations.length > 0){
			...
			for (cnt in theLocations){
				...
				if(resetCnt){
					...
					var inTheLocations = theLocations[cnt];
				}
				alert(" resetCnt = " + resetCnt + " || cnt = " + cnt + " || ");
				if ((inTheLocations.eventID != theStaticLocation.eventID) && (inTheLocations.eventLat == theStaticLocation.eventLat) && (inTheLocations.eventLong == theStaticLocation.eventLong)) {
					
					manyLocations.push(inTheLocations);
...
/* ========================================================= */
	function placeMarkers(theseLocations){
		...
		for (cntr = 0; cntr < theseLocations.length; cntr++){
